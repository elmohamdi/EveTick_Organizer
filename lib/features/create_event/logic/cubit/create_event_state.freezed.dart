...
mixin _$CreateEventState {
 ...
 CreateEventStatus get status; String? get eventTitle; String? get eventCategory; String? get eventDescription; String? get eventLocation; String? get eventUrl; DateTime? get startDate; TimeOfDay? get startTime; DateTime? get endDate; TimeOfDay? get endTime; bool get isOnlineEvent; XFile? get eventCoverImage; List<XFile> get eventGalleryPhotos; List<TicketTierModel> get eventTicketTiers; SeatingConfigModel? get seatingConfig; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,status,eventTitle,eventCategory,eventDescription,eventLocation,eventUrl,startDate,startTime,endDate,endTime,isOnlineEvent,eventCoverImage,const DeepCollectionEquality().hash(eventGalleryPhotos),const DeepCollectionEquality().hash(eventTicketTiers),seatingConfig,errorMessage);

@override
String toString() {
  return 'CreateEventState(status: $status, eventTitle: $eventTitle, eventCategory: $eventCategory, eventDescription: $eventDescription, eventLocation: $eventLocation, eventUrl: $eventUrl, startDate: $startDate, startTime: $startTime, endDate: $endDate, endTime: $endTime, isOnlineEvent: $isOnlineEvent, eventCoverImage: $eventCoverImage, eventGalleryPhotos: $eventGalleryPhotos, eventTicketTiers: $eventTicketTiers, seatingConfig: $seatingConfig, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 CreateEventStatus status, String? eventTitle, String? eventCategory, String? eventDescription, String? eventLocation, String? eventUrl, DateTime? startDate, TimeOfDay? startTime, DateTime? endDate, TimeOfDay? endTime, bool isOnlineEvent, XFile? eventCoverImage, List<XFile> eventGalleryPhotos, List<TicketTierModel> eventTicketTiers, SeatingConfigModel? seatingConfig, String? errorMessage
});
...
/// Create a copy of CreateEventState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? eventTitle = freezed,Object? eventCategory = freezed,Object? eventDescription = freezed,Object? eventLocation = freezed,Object? eventUrl = freezed,Object? startDate = freezed,Object? startTime = freezed,Object? endDate = freezed,Object? endTime = freezed,Object? isOnlineEvent = null,Object? eventCoverImage = freezed,Object? eventGalleryPhotos = null,Object? eventTicketTiers = null,Object? seatingConfig = freezed,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CreateEventStatus status,  String? eventTitle,  String? eventCategory,  String? eventDescription,  String? eventLocation,  String? eventUrl,  DateTime? startDate,  TimeOfDay? startTime,  DateTime? endDate,  TimeOfDay? endTime,  bool isOnlineEvent,  XFile? eventCoverImage,  List<XFile> eventGalleryPhotos,  List<TicketTierModel> eventTicketTiers,  SeatingConfigModel? seatingConfig,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateEventState() when $default != null:
return $default(_that.status,_that.eventTitle,_that.eventCategory,_that.eventDescription,_that.eventLocation,_that.eventUrl,_that.startDate,_that.startTime,_that.endDate,_that.endTime,_that.isOnlineEvent,_that.eventCoverImage,_that.eventGalleryPhotos,_that.eventTicketTiers,_that.seatingConfig,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CreateEventStatus status,  String? eventTitle,  String? eventCategory,  String? eventDescription,  String? eventLocation,  String? eventUrl,  DateTime? startDate,  TimeOfDay? startTime,  DateTime? endDate,  TimeOfDay? endTime,  bool isOnlineEvent,  XFile? eventCoverImage,  List<XFile> eventGalleryPhotos,  List<TicketTierModel> eventTicketTiers,  SeatingConfigModel? seatingConfig,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _CreateEventState():
return $default(_that.status,_that.eventTitle,_that.eventCategory,_that.eventDescription,_that.eventLocation,_that.eventUrl,_that.startDate,_that.startTime,_that.endDate,_that.endTime,_that.isOnlineEvent,_that.eventCoverImage,_that.eventGalleryPhotos,_that.eventTicketTiers,_that.seatingConfig,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CreateEventStatus status,  String? eventTitle,  String? eventCategory,  String? eventDescription,  String? eventLocation,  String? eventUrl,  DateTime? startDate,  TimeOfDay? startTime,  DateTime? endDate,  TimeOfDay? endTime,  bool isOnlineEvent,  XFile? eventCoverImage,  List<XFile> eventGalleryPhotos,  List<TicketTierModel> eventTicketTiers,  SeatingConfigModel? seatingConfig,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _CreateEventState() when $default != null:
return $default(_that.status,_that.eventTitle,_that.eventCategory,_that.eventDescription,_that.eventLocation,_that.eventUrl,_that.startDate,_that.startTime,_that.endDate,_that.endTime,_that.isOnlineEvent,_that.eventCoverImage,_that.eventGalleryPhotos,_that.eventTicketTiers,_that.seatingConfig,_that.errorMessage);case _:
  return null;
...
class _CreateEventState implements CreateEventState {
  const _CreateEventState({this.status = CreateEventStatus.initial, this.eventTitle, this.eventCategory, this.eventDescription, this.eventLocation, this.eventUrl, this.startDate, this.startTime, this.endDate, this.endTime, this.isOnlineEvent = true, this.eventCoverImage, final  List<XFile> eventGalleryPhotos = const [], final  List<TicketTierModel> eventTicketTiers = const [], this.seatingConfig, this.errorMessage}): _eventGalleryPhotos = eventGalleryPhotos,_eventTicketTiers = eventTicketTiers;
...
@override
int get hashCode => Object.hash(runtimeType,status,eventTitle,eventCategory,eventDescription,eventLocation,eventUrl,startDate,startTime,endDate,endTime,isOnlineEvent,eventCoverImage,const DeepCollectionEquality().hash(_eventGalleryPhotos),const DeepCollectionEquality().hash(_eventTicketTiers),seatingConfig,errorMessage);
...
/// Create a copy of CreateEventState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? eventTitle = freezed,Object? eventCategory = freezed,Object? eventDescription = freezed,Object? eventLocation = freezed,Object? eventUrl = freezed,Object? startDate = freezed,Object? startTime = freezed,Object? endDate = freezed,Object? endTime = freezed,Object? isOnlineEvent = null,Object? eventCoverImage = freezed,Object? eventGalleryPhotos = null,Object? eventTicketTiers = null,Object? seatingConfig = freezed,Object? errorMessage = freezed,}) {
