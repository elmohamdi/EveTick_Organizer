...
class _Initial implements CreateEventState {
  const _Initial();
...
class _Loading implements CreateEventState {
  const _Loading();
...
class _Success implements CreateEventState {
  const _Success();
...
@override
String toString() {
  return 'CreateEventState.success()';
}
...
class _Failure implements CreateEventState {
...
@override
String toString() {
  return 'CreateEventState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $CreateEventStateCopyWith<$Res> {
